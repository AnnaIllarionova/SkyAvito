...
export const AdvertisementText = ({ setTitleValue, setDescriptionValue, data, titleValue, descriptionValue, isLoading }) => {
useEffect(() => {
        ...
        <>
              ...
              <S.FormNewArtBlockAdv>
                ...
                <S.FormNewArtAreaDescription
                  ...
                  value={data && (isLoading ? "Данные загружаются..." : descriptionValue)}
